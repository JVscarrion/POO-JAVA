public class ContaNormal extends Cliente
{
    int tipoMovimentacao;
    double valorMovimentacao;
    String data;

    public ContaNormal (int codigo, String nomeCliente, String sexo, String dataNascimento, double saldo, int tipoMovimentacao, double valorMovimentacao, String data) {
