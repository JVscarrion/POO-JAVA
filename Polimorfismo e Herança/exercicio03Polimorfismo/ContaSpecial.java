public class ContaSpecial extends Cliente
{
    int tipoMovimentacao;
    double valorMovimentacao;
    String data;

    public ContaSpecial (int codigo, String nomeCliente, String sexo, String dataNascimento, double saldo, int tipoMovimentacao, double valorMovimentacao, String data) {
